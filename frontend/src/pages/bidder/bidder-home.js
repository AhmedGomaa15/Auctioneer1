              ...
              <div key={item.id} className="cardDesign">
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <h5 className="card-title">endDate:{item.endDate}</h5>
                    <span className="card-text">Seller: {item.user.name}</span>
                    <br></br>
                    <ul className="list-inline mb-0">
                                      <li className="list-inline-item">
                                        <Link to={`/Update-Bid/${item.id}`} className="btn btn-outline-danger  btn-block">
                                          Bid Now
                                        </Link>
                                      </li>
                                      </ul>
